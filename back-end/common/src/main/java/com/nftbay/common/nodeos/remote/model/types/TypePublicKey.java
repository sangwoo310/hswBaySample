...
import com.nftbay.common.nodeos.crypto.ec.EosPublicKey;
...
public class TypePublicKey implements EosType.Packer {
    ...
    public void pack(EosType.Writer writer) {
        writer.putVariableUInt(
                mPubKey.isCurveParamK1() ? PACK_VAL_CURVE_PARAM_TYPE_K1 : PACK_VAL_CURVE_PARAM_TYPE_R1);
