...
package com.nftbay.common.nodeos.crypto;

import com.nftbay.common.nodeos.crypto.util.BitUtils;
import com.nftbay.common.nodeos.crypto.util.HexUtils;
...
public class Hmac {
    ...
    public static boolean testTestVectors() {
        ...
        expected_256 =
                HexUtils.toBytes("b0344c61d8db38535ca8afceaf0bf12b881dc200c9833da726e9376c2e32cff7");
        ...
        if (!BitUtils.areEqual(result_256, expected_256) || !BitUtils
                .areEqual(result_512, expected_512)) {
            return false;
        }
        ...
        expected_256 =
                HexUtils.toBytes("5bdcc146bf60754e6a042426089575c75a003f089d2739839dec58b964ec3843");
        expected_512 = HexUtils.toBytes(
        ...
        expected_256 =
                HexUtils.toBytes("773ea91e36800e46854db8ebd09181a72959098b3ef8c122d9635514ced565fe");
        expected_512 = HexUtils.toBytes(
                "fa73b0089d56a284efb0f0756c890be9b1b5dbdd8ee81a3655f83e33b2279d39bf3e848279a722c806b485a47e67c807b946a337bee8942674278859e13292fb");
        result_256 = Hmac.hmacSha256(key, data);
        result_512 = Hmac.hmacSha512(key, data);
        return !(!BitUtils.areEqual(result_256, expected_256) || !BitUtils
                .areEqual(result_512, expected_512));
    }
}
