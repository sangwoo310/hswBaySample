...
public class GrapheneUtils {
    ...
    public byte[] calculateChecksum(byte[] publicKey) {
    ...
    public String getAddressFromPublicKey(String prefix, eu.bittrade.crypto.core.ECKey privKey) {
        try {
    ...
    public String getGrapheneWifFromPrivateKey(eu.bittrade.crypto.core.ECKey pKey) {
    ...
    public eu.bittrade.crypto.core.ECKey GrapheneWifToPrivateKey(String Wif) {
    ...
    public String SignMessage(String message, eu.bittrade.crypto.core.ECKey privKey) {
        ...
        return Base58.encode(sigData);
    }

    public boolean VerifyMessage(String message, String sigBase64, PublicKey pubKey) {
        try {

            byte[] encodedSig;
            encodedSig = Base58.decode(sigBase64);
    ...
    public String SignEosMessage(String message, eu.bittrade.crypto.core.ECKey privKey) {
        Sha256Hash messageAsHash = Sha256Hash.of(message.getBytes());
        ECKey.ECDSASignature sigObj = privKey.sign(messageAsHash);
    ...
    public boolean VerifyEosMessage(String message, String sigBase58, PublicKey pubKey) {
        try {
